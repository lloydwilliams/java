...
helm install datadog-agent -f values-aks.yaml --set datadog.site='datadoghq.com' --set datadog.apiKey=$DATADOG_API_KEY --set datadog.appKey=$DATADOG_APP_KEY --create-namespace=true datadog/datadog 
